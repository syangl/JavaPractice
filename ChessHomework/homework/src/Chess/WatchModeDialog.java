...
public class WatchModeDialog extends JDialog{
	private WatchModeDialog() {};
	private static WatchModeDialog instance;
	public static WatchModeDialog getInstance(){
		if(instance == null) {
			instance = new WatchModeDialog();
			instance.create();
		}
	...
	public void create() {
		...
		know.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				NorthPanel.getInstance().linkBar.setText("你是旁观者，正在旁观对局");
				dispose();
			}
		});
		...
		JTextArea overText = new JTextArea("   你正在旁观对局");
