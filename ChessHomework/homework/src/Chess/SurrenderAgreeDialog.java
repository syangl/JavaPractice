...
public class SurrenderAgreeDialog extends JDialog{
	private SurrenderAgreeDialog() {};
	private static SurrenderAgreeDialog instance;
	public static SurrenderAgreeDialog getInstance(){
		if(instance == null) {
			instance = new SurrenderAgreeDialog();
			instance.create();
		}
	...
	public void create() {
		...
		know.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				dispose();
				ChessView.getInstance().surrender();
			}
		});
		...
		JTextArea overText = new JTextArea("   对方同意认输");
