...
public class WithdrawAgreeDialog extends JDialog{
	private WithdrawAgreeDialog() {};
	private static WithdrawAgreeDialog instance;
	public static WithdrawAgreeDialog getInstance(){
		if(instance == null) {
			instance = new WithdrawAgreeDialog();
			instance.create();
		}
	...
	public void create() {
		...
		JTextArea overText = new JTextArea("   对方同意悔棋");
