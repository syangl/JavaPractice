...
public class SurrenderDisagreeDialog extends JDialog{
	private SurrenderDisagreeDialog() {};
	private static SurrenderDisagreeDialog instance;
	public static SurrenderDisagreeDialog getInstance(){
		if(instance == null) {
			instance = new SurrenderDisagreeDialog();
			instance.create();
		}
	...
	public void create() {
		...
		JTextArea overText = new JTextArea("   对方不同意认输");
